...
/**
 * Copied from
 * org.knime.base.node.io.database.DBReaderNodeModel
 */

class HiveReaderNodeModel extends NodeModel
    ...
    private final HiveReaderConnection m_load =
        new HiveReaderConnection(null);
     ...
     */
    HiveReaderNodeModel(final int ins, final int outs) {
        super(ins, outs);
    }
