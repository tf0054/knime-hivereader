 ...
 */
public class HiveReaderNodePlugin extends Plugin {
    // The shared instance.
    private static HiveReaderNodePlugin plugin;

    /**
     * The constructor.
     */
    public HiveReaderNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static HiveReaderNodePlugin getDefault() {
        return plugin;
    }
